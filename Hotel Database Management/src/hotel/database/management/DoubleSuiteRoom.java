 ...
 * @author Amoli Shah
 */
public class DoubleSuiteRoom extends javax.swing.JFrame {

    int Days,Rooms,BillAmount;
    Date CheckIn,CheckOut;
    /**
     * Creates new form DoubleSuiteRoom
     */
    public DoubleSuiteRoom() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Rs 1700/- per night");
    ...
    private void BookBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BookBtnActionPerformed
        try {
            ...
            else
            {
                ...
                myStmt.executeUpdate("insert into Credentials (RoomType,Days,BillAmount) Values('Double Suite','"+Days+"','"+BillAmount+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoubleSuiteRoom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoubleSuiteRoom().setVisible(true);
            }
        });
    }
