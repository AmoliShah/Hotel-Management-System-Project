 ...
 * @author Amoli Shah
 */
public class SwissRoom extends javax.swing.JFrame {

    int Days,Rooms,BillAmount;
    Date CheckIn,CheckOut;
    /**
     * Creates new form SwissRoom
     */
    public SwissRoom() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Rs 2000/- per night");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SwissRoom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
